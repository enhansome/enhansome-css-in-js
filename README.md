...
* [styled-components](https://github.com/styled-components/styled-components) ⭐ 41,101 | 🐛 27 | 🌐 TypeScript | 📅 2026-09-08 - Universal, Dynamic & High-Performance Styling in JavaScript
* [linaria](https://github.com/callstack/linaria) ⭐ 12,349 | 🐛 72 | 🌐 TypeScript | 📅 2026-08-10 - Zero-runtime CSS in JS library
...
* [jss](https://github.com/cssinjs/jss) ⭐ 7,052 | 🐛 225 | 🌐 JavaScript | 📅 2024-08-13 - JSS is a CSS authoring tool which uses JavaScript as a host language
* [aphrodite](https://github.com/Khan/aphrodite) ⭐ 5,338 | 🐛 91 | 🌐 JavaScript | 📅 2025-07-24 - It's inline styles, but they work! Also supports styling via CSS
...
| :-----------------------------------------------------------------------------------------------------------------------------: | :-------: | :---: | :-: | ---------- | -------- | ------- | ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | - |
|              [emotion](https://github.com/emotion-js/emotion) ⭐ 18,019 \| 🐛 394 \| 🌐 JavaScript \| 📅 2026-08-28              |     ✅     |   ✅   |  ✅  | ✅          | ✅        | ✅       | ✅             | react-emotion, preact-emotion                                                                                                                                                                                                                                                    |   |
...
|                    [jss](https://github.com/cssinjs/jss) ⭐ 7,052 \| 🐛 225 \| 🌐 JavaScript \| 📅 2024-08-13                    |     ✅     |   ✅   |  ✅  |            | ✅        | ✅       | ✅             | [react-jss](https://github.com/cssinjs/react-jss) [styled-jss](https://github.com/cssinjs/styled-jss) ⭐ 214 \| 🐛 20 \| 🌐 JavaScript \| 📅 2018-12-31                                                                                                                           |   |
...
| [styled-components](https://github.com/styled-components/styled-components) ⭐ 41,101 \| 🐛 27 \| 🌐 TypeScript \| 📅 2026-09-08 |           |   ✅   |  ✅  | ✅          |          | ✅       | ✅             |                                                                                                                                                                                                                                                                                  |   |
...
* [MicheleBertoli/css-in-js](https://github.com/MicheleBertoli/css-in-js) ⭐ 5,472 | 🐛 6 | 🌐 JavaScript | 📅 2024-04-02 React: CSS in JS techniques comparison.
