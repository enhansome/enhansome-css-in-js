...
* [styled-components](https://github.com/styled-components/styled-components) ⭐ 41,121 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-17 - Universal, Dynamic & High-Performance Styling in JavaScript
* [linaria](https://github.com/callstack/linaria) ⭐ 12,344 | 🐛 72 | 🌐 TypeScript | 📅 2026-08-10 - Zero-runtime CSS in JS library
...
| :-----------------------------------------------------------------------------------------------------------------------------: | :-------: | :---: | :-: | ---------- | -------- | ------- | ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | - |
|              [emotion](https://github.com/emotion-js/emotion) ⭐ 18,016 \| 🐛 389 \| 🌐 JavaScript \| 📅 2026-05-06              |     ✅     |   ✅   |  ✅  | ✅          | ✅        | ✅       | ✅             | react-emotion, preact-emotion                                                                                                                                                                                                                                                    |   |
